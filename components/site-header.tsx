          ...
          <div className="container flex h-30 items-center space-x-4 sm:justify-between sm:space-x-0">
            ...
            <div className="flex flex-1 items-center justify-end space-x-4">
              <nav className="flex items-center space-x-1">
                ...
                <Link
                  href="mailto:Kzlocmaroc@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <div
  ...
  return (
    <header className="bg-background dark:bg-black sticky top-0 z-40 w-full border-b">
      <div className="container flex h-30 items-center space-x-4 sm:justify-between sm:space-x-0">
        ...
        <div className="flex flex-1 items-center justify-end space-x-4">
          <nav className="flex items-center space-x-1">
            {user?.name === "amineamoune904@gmail.com" || user?.name === "Kzlocmaroc@gmail.com"? null : (
              <>
                <Link
                  href="https://wa.me/212707616180/"
                  target="_blank"
            ...
            <div className="hidden md:block">
              {(user?.name === "amineamoune904@gmail.com"|| user?.name === "Kzlocmaroc@gmail.com") && (
                <Link
