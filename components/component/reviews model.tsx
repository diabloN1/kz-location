...
export function Reviewsmodel({ id }: { id: any }) {
  //start count
  ...
  // useEffect(() => {
  //   reviewsData?.rate?.map((rate: any) => {
  //     setSum(sum + rate);
  //   });
  //   setAvgRating(sum / reviewsData?.rate?.length);
...
function StarIcon(props: any) {
  return (
    ...
    //   strokeLinecap="round"
    //   strokeLinejoin="round"
    //   className={`clip-path-polygon(${100 - 30}% 0, 100% 0, 100% 100%, 0 100%)`}
    // >
    //   <polygon
